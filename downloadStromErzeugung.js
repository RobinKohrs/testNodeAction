...
export default async function donwloadStromErzeugung() {
  ...
  const response = await fetch(url, {
    headers: {
      ...
      Referer:
        "https://transparency.apg.at/erzeugung-nach-typ/export?hideTitle=1&hideDescription=1&fromDate=2022-10-18T000000&exportTo=2022-10-19T000000&resolution=M15&language=German",
